...
// คืนเงินภายในกี่วันหลังอนุมัติคำขอคืนบัตร — ทีมยืนยัน 14 วัน (2026-08-27) แก้ตรงนี้ที่เดียว
export const REFUND_DAYS = 14;

// อีเมลติดต่อเรื่องข้อมูลส่วนบุคคล/ปัญหาการใช้งาน — ลำดับ: SUPPORT_EMAIL → SEED_ADMIN_EMAIL (อีเมลแอดมิน, ทีมตัดสิน 2026-08-27)
//   → null = ไม่มีทั้งคู่ (หน้านโยบายจะชี้ไปแชตช่วยเหลือในเว็บแทน)
export function getSupportEmail(): string | null {
  const value = env.SUPPORT_EMAIL?.trim() || env.SEED_ADMIN_EMAIL?.trim();

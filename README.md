...
**สงวนลิขสิทธิ์ (All rights reserved)** — เผยแพร่เพื่อการตรวจสอบทางวิชาการ/พอร์ตโฟลิโอเท่านั้น ห้ามคัดลอก/ดัดแปลง/นำไปใช้โดยไม่ได้รับอนุญาต ดูรายละเอียดใน [`LICENSE`](LICENSE) (ทีมอาจเปลี่ยนเป็นสัญญาอนุญาตแบบเปิดภายหลัง)
